...
product_line_layout_tpl = """
  ...
  <div class="col-md-3" id="products-<%= row %>"></div>
  <div class="col-md-1" id="line-item-inputs-price-<%= row %>">

  <!-- NOTE: ids must be 3 tokens wide -->
    <input id="sales-price-<%= row %>" size=5 name="sales-price"/ placeholder="Sales Price" class="discount-calculator-input sales-price">
  </div>
  <div class="col-md-1" id="line-item-inputs-quantity-<%= row %>">
    <input id="product-quantity-<%= row %>" size=5 name="quantity" placeholder="Quantity"  class="discount-calculator-input sales-price"/>
  </div>
  <div class="col-md-1 calulation-float" id="line-item-guiden-price-<%= row %>">&nbsp;</div>
